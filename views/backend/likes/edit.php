...
/* // Ligne PHP : /*
 * Vue d'administration (édition) pour le module likes. // Ligne PHP : * Vue d'administration (édition) pour le module likes.
 * - Le formulaire réutilise la structure de création mais avec des valeurs pré-remplies côté serveur. // Ligne PHP : * - Le formulaire réutilise la structure de création mais avec des valeurs pré-remplies côté serveur.
 * - Les identifiants nécessaires (ID) sont passés via la query string ou des champs cachés. // Ligne PHP : * - Les identifiants nécessaires (ID) sont passés via la query string ou des champs cachés.
 * - L'action du formulaire cible la route de mise à jour correspondante. // Ligne PHP : * - L'action du formulaire cible la route de mise à jour correspondante.
 * - Les sections HTML isolent les groupes d'attributs pour une édition guidée. // Ligne PHP : * - Les sections HTML isolent les groupes d'attributs pour une édition guidée.
 * - Les actions secondaires permettent de revenir à la liste sans enregistrer. // Ligne PHP : * - Les actions secondaires permettent de revenir à la liste sans enregistrer.
 */ // Ligne PHP : */
require_once $_SERVER['DOCUMENT_ROOT'] . '/config.php'; // Ligne PHP : require_once $_SERVER['DOCUMENT_ROOT'] . '/config.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/functions/redirec.php'; // Ligne PHP : require_once $_SERVER['DOCUMENT_ROOT'] . '/functions/redirec.php';
...
$ba_bec_selectedArticleTitle = ''; // Ligne PHP : $ba_bec_selectedArticleTitle = '';
$ba_bec_selectedMemberPseudo = ''; // Ligne PHP : $ba_bec_selectedMemberPseudo = '';
...
if (isset($_GET['numMemb']) && isset($_GET['numArt'])) { // Ligne PHP : if (isset($_GET['numMemb']) && isset($_GET['numArt'])) {
    ...
    $ba_bec_selectedArticleTitle = $ba_bec_articleIdToTitle[$ba_bec_numArt] ?? ''; // Ligne PHP : $ba_bec_selectedArticleTitle = $ba_bec_articleIdToTitle[$ba_bec_numArt] ?? '';
    $ba_bec_selectedMemberPseudo = $ba_bec_memberIdToPseudo[$ba_bec_numMemb] ?? ''; // Ligne PHP : $ba_bec_selectedMemberPseudo = $ba_bec_memberIdToPseudo[$ba_bec_numMemb] ?? '';
} // Ligne PHP : }
...
<div class="container"> <!-- Ligne HTML : <div class="container"> -->
    <div class="row"> <!-- Ligne HTML : <div class="row"> -->
        <div class="col-md-12"> <!-- Ligne HTML : <div class="col-md-12"> -->
            <h1>Modification Like</h1> <!-- Ligne HTML : <h1>Modification Like</h1> -->
        </div> <!-- Ligne HTML : </div> -->
        <div class="col-md-12"> <!-- Ligne HTML : <div class="col-md-12"> -->
            <!-- Form to edit like --> <!-- Ligne HTML : <!- - Form to edit like - -> -->
            <form action="<?php echo ROOT_URL . '/api/likes/update.php' ?>" method="post"> <!-- Ligne HTML : <form action="<?php echo ROOT_URL . '/api/likes/update.php' ?>" method="post"> -->
                <div class="form-group"> <!-- Ligne HTML : <div class="form-group"> -->
                    <label for="numArt">Article (ID)</label> <!-- Ligne HTML : <label for="numArt">Article (ID)</label> -->
                    <input id="numArt" name="numArt" class="form-control" type="text" <!-- Ligne HTML : <input id="numArt" name="numArt" class="form-control" type="text" -->
                        value="<?php echo $ba_bec_numArt; ?>" /> <!-- Ligne HTML : value="<?php echo $ba_bec_numArt; ?>" /> -->
                    <input id="numArt" name="numArt" class="form-control" type="text" value="<?php echo $ba_bec_numArt; ?>" <!-- Ligne HTML : <input id="numArt" name="numArt" class="form-control" type="text" value="<?php echo $ba_bec_numArt; ?>" -->
                        placeholder="ID article (ex: 42)" /> <!-- Ligne HTML : placeholder="ID article (ex: 42)" /> -->
                </div> <!-- Ligne HTML : </div> -->
                <br> <!-- Ligne HTML : <br> -->

                <div class="form-group"> <!-- Ligne HTML : <div class="form-group"> -->
                    <label for="numMemb">Utilisateur (ID)</label> <!-- Ligne HTML : <label for="numMemb">Utilisateur (ID)</label> -->
                    <input id="numMemb" name="numMemb" class="form-control" type="text" <!-- Ligne HTML : <input id="numMemb" name="numMemb" class="form-control" type="text" -->
                        value="<?php echo $ba_bec_numMemb; ?>" placeholder="ID utilisateur (ex: 7)" /> <!-- Ligne HTML : value="<?php echo $ba_bec_numMemb; ?>" placeholder="ID utilisateur (ex: 7)" /> -->
                </div> <!-- Ligne HTML : </div> -->
                <br> <!-- Ligne HTML : <br> -->
                ...
                <div class="form-group"> <!-- Ligne HTML : <div class="form-group"> -->
                    ...
                    <div class="form-check form-switch"> <!-- Ligne HTML : <div class="form-check form-switch"> -->
                        ...
                        <input class="form-check-input" type="checkbox" id="likeA" name="likeA" value="1" <!-- Ligne HTML : <input class="form-check-input" type="checkbox" id="likeA" name="likeA" value="1" -->
                            <?php echo ($ba_bec_likeA == 1 ? 'checked' : ''); ?> /> <!-- Ligne HTML : <?php echo ($ba_bec_likeA == 1 ? 'checked' : ''); ?> /> -->
                ...
                <div class="form-group mt-2"> <!-- Ligne HTML : <div class="form-group mt-2"> -->
                    <a href="list.php" class="btn btn-primary">Retour à la liste</a> <!-- Ligne HTML : <a href="list.php" class="btn btn-primary">Retour à la liste</a> -->
                    <button type="submit" class="btn btn-danger">Confirmer la modification ?</button> <!-- Ligne HTML : <button type="submit" class="btn btn-danger">Confirmer la modification ?</button> -->
                </div> <!-- Ligne HTML : </div> -->
