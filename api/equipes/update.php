...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($ba_bec_numEquipe === '' || $ba_bec_libEquipe === '') {
    ...
    if (empty($ba_bec_errors)) {
        ...
        $ba_bec_updates = "libEquipe = '$ba_bec_libEquipe', categorieEquipe = $ba_bec_categorieValue, sectionEquipe = $ba_bec_sectionValue, niveauEquipe = $ba_bec_niveauValue";
        sql_update('EQUIPE', $ba_bec_updates, "numEquipe = '$ba_bec_numEquipe'");
