-- Script d'injection pour phpMyAdmin : 4 équipes seniors garçons, 3 équipes seniors filles
-- + 2 journées par équipe + membres du bureau + coachs + commissions
-- Base cible : BLOGART26
