    ...
    $schemas = [
        ...
        'PERSONNEL' => [
            "CREATE TABLE IF NOT EXISTS `PERSONNEL` (
                ...
                KEY `idx_personnel_equipe` (`codeEquipeStaff`),
                CONSTRAINT `fk_personnel_equipe` FOREIGN KEY (`codeEquipeStaff`) REFERENCES `EQUIPE` (`codeEquipe`) ON DELETE SET NULL ON UPDATE CASCADE
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;",
        ],
        'MATCH' => [
